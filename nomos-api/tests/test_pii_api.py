...
class TestPIIFilterEndpoint:
    async def test_filter_pii_email(self, client) -> None:
        response = await client.post("/api/pii/filter", json={"text": "Email: max@example.com, Tel: +43 1 234 5678"})
