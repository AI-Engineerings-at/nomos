...
**Architecture:** FastAPI Auth Middleware die JEDEN API-Call prueft. JWT in HttpOnly Cookie. TOTP 2FA via pyotp. BIP-39 Recovery Key (12 Woerter). Rollen-basierte Zugriffskontrolle (Admin/User/Officer). Rate Limiting via Valkey — done (migrated in Enterprise Hardening sprint).
